...
import { SECTIONS } from "../audio/presets";
 ...
 *
 * Durations are read from the presets rather than written into the prose, so
 * retuning the session structure cannot leave an essay behind that confidently
        ...
        <article className="phibody">
          ...
          <section className="phisection">
            ...
            <p>
              ...
              carry — one that is identical every time, that costs nothing to
              enter, and that nobody else can walk into.
            </p>
          ...
          <section className="phisection">
            ...
            <p>
              ...
              here is a shortcut — it is a deposit, and the interest is paid in
              months.
            </p>
          </section>
          ...
          <section className="phisection">
            ...
            <ul className="philist">
              <li>
                ...
                Deliberately short — long enough to be a threshold, too short
                to be a wait. This is the part your nervous system will
              ...
              <li>
                ...
                ultradian cycle — the natural period over which sustained
            ...
            <p>
              Then it loops — but back to Transition, never to Initiation. You
              cross a threshold once. Replaying the doorway every {deep}{" "}
          ...
          <section className="phisection">
            ...
            <p>
              ...
              {SETTLE_DELAY.toFixed(1)} seconds after the change begins — and a
              beat and a half after the fade has already finished — there is a
              click.
            </p>
            <p>
              ...
              — a light switch reaching the end of its travel.
            </p>
            <p>
          ...
          <section className="phisection">
            ...
            <p>
              ...
              interrupt it — you did not stop working, you changed the weather.
              So the session clock keeps its number.
            </p>
            <p>
          ...
          <section className="phisection">
            ...
            <p>
              ...
              to repeat — the same session run twice is genuinely two different
              performances of one idea.
            </p>
            <p>
          ...
          <section className="phisection">
            ...
            <p>
              ...
              analyser. It moves at the pace the mode moves — slow, wide drift
              under Focus and Relax; faster, tighter motion under Pump — so
              that what you see and what you hear are two readings of the same
              tempo rather than two competing signals.
            </p>
            <p>
              Peripheral vision is far more sensitive to rate of change than to
              detail. Matching the visual rate to the musical one means the
              screen reinforces the state instead of quietly arguing with it,
              which is what a mismatched animation does whether or not you
              notice.
            </p>
          </section>
          ...
          <section className="phisection">
            ...
            <p>
              ...
              selling you relief from it — which is the exact opposite of what
              a room you can think in is for. The measurement exists so you can
              look at it if you want to. It will never come looking for you.
            </p>
          </section>
