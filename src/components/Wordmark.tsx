 ...
 *
 * The path data is a Bezier reduction of the drawn outlines - three closed
 * contours, `nonzero` fill so the overlapping strokes union rather than
 * cancel where the bar crosses the stem.
 */
